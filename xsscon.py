...
def start():
	...
	pos_opt.add_argument("--depth",metavar="",help="Depth web page to crawl. Default: 2",default=2) # 爬虫深度
	pos_opt.add_argument("--payload-level",metavar="",help="Level for payload Generator, 7 for custom payload. {"
	                                                       "1...6}. Default: 6",default=6) # 生成级别
	...
	pos_opt.add_argument("--single",metavar="",help="Single scan. No crawling just one address") # 单一扫描,不爬取
